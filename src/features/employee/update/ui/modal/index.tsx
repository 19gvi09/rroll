...
export const UpdateEmployeeModal: FC<IUpdateEmployeeModalProps> = ({employee, grades}) => {
  ...
  return (
    <>
      ...
      <Modal title="Редактировать сотрудника" open={open} onCancel={cancel} onOk={() => form.submit()}>
        <EmployeeForm grades={grades} initialValues={employee} form={form} onFinish={submit} />
      </Modal>
    </>
  )
}